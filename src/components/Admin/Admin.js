                    ...
                    <div className="card-body">
                        ...
                        <form>
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control mx-auto w-100" id="inputAddress"
                                       placeholder="nom des équipes"/>
                            </div>
                            <div className="form-row">
                                <div className="form-group col-md-6">
                                    <label htmlFor="inputEmail4">Equipe 1</label>
                                    <input type="email" className="form-control mx-auto w-100" id="inputEmail4"/>
                                </div>
                                <div className="form-group col-md-6">
                                    <label htmlFor="inputPassword4">Equipe 2</label>
                                    <input type="password" className="form-control mx-auto w-100" id="inputPassword4"/>
                                </div>
                            </div>
                            <div className="form-row">
                                <div className="form-group col-md-6">
